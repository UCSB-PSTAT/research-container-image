            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"assist\");library(\"geosphere\");library(\"glmnet\");library(\"tictoc\");library(\"expm\");library(\"imputeTS\");library(\"zipcode\")"'
